    ...
    return (
      <div className='py-[10rem]  max-w-[1640px] md:mx-auto grid-col  grid-cols-2 gap-10 px-20 justify-center w-[80rem]  cursor-pointer '> 
        ...
        <div className='flex gap-10 justify-center m-10'>
          <div onClick={() => navigate("/Project")} className=' bg-[#48587C] idom cursor-pointerbg-[#48587C] text-white px-8 p-2  flex justify-center  rounded-lg'>
            <p >All</p>
          </div>
        ...
        <div className='py-[5em] max-w-[1640px] md:mx-auto grid-col  grid-cols-2 gap-10 px-20 justify-center w-[80rem]  cursor-pointer '> 
