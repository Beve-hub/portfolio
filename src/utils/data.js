...
export  const data = [  
    ...
    { 
        image: Ezigbo,
        title: 'Ezigbo',
        description: 'A blockchain-based platform for that allow users check product condition and expiry date it also save it to the blockchain cloud using smart contract .',
        behanceURL: 'https://www.behance.net/gallery/180894407/Ezigbo-(authentic)',
        URL: 'https://ezigbo.vercel.app/',          
    },
    { 
        image: room,
